...
The two after-change median-throughput series were 19,744-20,104 msg/s for in-process tell, 13,234-13,652 for in-process ask, 27,854-29,528 for two-process tell, and 21,320-22,277 for two-process ask. Compared with the latest Epic 09 series, three workloads improved while two-process tell measured lower; this host-level throughput remains too noisy to treat that single workload as a regression without profiler evidence. Allocation reductions were consistent in every measured run.
