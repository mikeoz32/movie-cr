...
| P0 | [Epic 16 - Pluggable Persistence and PostgreSQL](epics/epic-16-pluggable-persistence-and-postgresql.md) | Separates persistence semantics from SQLite and adds a shared PostgreSQL backend for multi-node recovery. | In progress |
