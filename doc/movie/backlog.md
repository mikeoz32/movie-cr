...
| P0 | [Epic 14 - Receiver Handoff Contention](epics/epic-14-receiver-handoff-contention.md) | Measures and removes receiver-side lock and scheduling amplification before changing the wire codec. | In progress |
