...
| P1 | [Epic 04 - Configuration API Consistency](epics/epic-04-configuration-api-consistency.md) | Removes ambiguous config behavior and normalizes public settings. | Completed (2026-08-20) |
